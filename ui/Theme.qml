...
QtObject {
    ...
    readonly property color windowColor: darkMode ? "#151815" : "#f1f3ef"
    readonly property color surfaceColor: darkMode ? "#202421" : "#ffffff"
    readonly property color surfaceMutedColor: darkMode ? "#282d29" : "#e9ede8"
    readonly property color readingColor: darkMode ? "#1b1f1c" : "#fbfaf7"
    readonly property color textColor: darkMode ? "#edf0eb" : "#20231f"
    readonly property color mutedTextColor: darkMode ? "#aab1ab" : "#646a64"
    readonly property color disabledTextColor: darkMode ? "#747c76" : "#9aa09a"
    readonly property color borderColor: darkMode ? "#373d38" : "#d9ddd7"
    readonly property color strongBorderColor: darkMode ? "#4b534c" : "#bdc4bd"

    readonly property color accentColor: darkMode ? "#7db58e" : "#315f43"
    readonly property color accentHoverColor: darkMode ? "#91c49f" : "#284f38"
    readonly property color accentPressedColor: darkMode ? "#69a47b" : "#20412e"
    readonly property color accentSoftColor: darkMode ? "#294032" : "#e2ebe4"
    ...
    readonly property color focusColor: darkMode ? "#d39a68" : "#a95f40"
